#ifndef  _csnc_package_deal_h_
#define  _csnc_package_deal_h_
...
//
extern	void	DataPackage_CSNC(stcCsncProtocolPara * sprotocolpara);

//数据解包，将接受到的数据解包到，stcCsnrProtocolPara信息
//简析正确，返回1；否则，返回0
extern unsigned char   DataUnpack_CSNC(stcCsncProtocolPara *sprotocolpara);
