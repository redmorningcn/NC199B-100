...
typedef  struct  modbus_ch {
    ...
    //CPU_INT08U       RxByteTimeOut;                     // 字符间超时
...
#define COM_EXCEPTIONS      pch->StatExceptCtr
#define COM_PACKETSTOUNIT   pch->StatSlaveMsgCtr
#define COM_BADCRC          pch->StatCRCErrCtr
#define COM_TIMEOUT         pch->StatNoRespCtr
